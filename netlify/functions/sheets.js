...
export default function Admin() {
  ...
  // ✅ safe (evita problemi se build/SSR)
  ...
  const qrUrl = useMemo(() => {
    if (!baseUrl) return "";
    return `${baseUrl}/r/${encodeURIComponent(normalizedCode)}`;
  }, [baseUrl, normalizedCode]);
  ...
  async function safeReadJson(res) {
    ...
    // prova a parsare se il server manda JSON come text/plain
    try {
